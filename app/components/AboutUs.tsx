        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-8">
            ...
            <p className="text-gray-600 mb-4">
              Founded in 2023, Ayywa Trading Company LLC has established itself as a leading player in the global trading industry. Based in the heart of Dubai, we leverage our strategic location to connect businesses across continents.
            </p>
            <p className="text-gray-600 mb-4">
